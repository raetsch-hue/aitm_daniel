...
| Datei | Was drin ist |
|---|---|
| [`skill-c-level-pitch.md`](skill-c-level-pitch.md) | **Die Methode.** Vom fremden Unternehmensprofil zur fertigen Präsentation: zwölf Pflichtwerte, Zuschnitt unter die Freigabegrenze, Kriterien herleiten, gewichten, Sensitivität, 14 Folien, Sprechunterlagen, Datenblatt |
...
Der Skill liegt bewusst **hier** und nicht unter `.claude/skills/`. Wer ihn in Claude Code aufrufbar machen will, kopiert ihn als `SKILL.md` nach `.claude/skills/c-level-pitch/` — das Frontmatter ist bereits dafür gebaut.
