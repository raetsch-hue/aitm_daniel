...
![MCP Settings Example](../../bilder/huggingface.co_datasets_huggingface_documentation-images_resolve_main_hf-mcp-settings.png)
...
![HF MCP with Spaces in VS Code](../../bilder/huggingface.co_datasets_huggingface_documentation-images_resolve_main_hf-mcp-vscode.png)
