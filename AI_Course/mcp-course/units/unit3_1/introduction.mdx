...
![PR Agent Architecture](../../bilder/huggingface.co_datasets_mcp-course_images_resolve_main_unit3_architecture.png)
...
![Webhook Flow](../../bilder/huggingface.co_datasets_huggingface_documentation-images_resolve_main_hub_webhooks-guides_001-discussion-bot_webhook-creation.png)
