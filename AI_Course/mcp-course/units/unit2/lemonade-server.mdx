...
![Lemonade Server Interface](../../bilder/raw.githubusercontent.com_lemonade-sdk_assets_refs_heads_main_huggingface_course_hf_lemonade.png)
...
![Custom Model](../../bilder/raw.githubusercontent.com_lemonade-sdk_assets_refs_heads_main_huggingface_course_custom_model.png)

All done! Now let's give it a try.

### Taking it for a spin

![recording](../../bilder/raw.githubusercontent.com_lemonade-sdk_assets_refs_heads_main_huggingface_course_recording.gif)
