# ADKAR-Scoring: Einführung eines GenAI-Assistenten für Kampagnen- und Content-Erstellung

| | |
|---|---|
| **Bereich** | Marketing |
| **Umfang** | 18 Personen im Content-Team, 2 Agenturen angebunden |
...
Skala: 1 = nicht vorhanden · 2 = ansatzweise · 3 = teilweise · 4 = überwiegend · 5 = voll gegeben
...
**D – Desire (Wunsch mitzumachen): Score 4**  
Aktuelle Produktinformationen und Inhalte, um die neuen Produkte des Unternehmens gezielt zu vermarkten und den Verkauf zu fördern.

**K – Knowledge (Wissen, wie es geht): Score 2**  
Es fehlt noch an Wissen über die konkreten Einsatzmöglichkeiten und Grenzen von KI. Teilweise herrscht die Vorstellung: ‚KI kann doch einfach alles.

**A – Ability (Fähigkeit in der Praxis): Score 3**  
Grundsätzlich sind die Mitarbeitenden in der Lage, den GenAI-Assistenten im Arbeitsalltag anzuwenden.
...
**D – Desire (Wunsch mitzumachen): Score 3**  
Grundsätzlich besteht Interesse. Die Sorge um den eigenen Arbeitsplatz führt jedoch zu Zurückhaltung. Eine glaubwürdige Arbeitsplatzgarantie würde die Bereitschaft deutlich erhöhen.

**K – Knowledge (Wissen, wie es geht): Score 2**  
Es fehlt noch an konkretem Wissen darüber, welche Aufgaben die KI übernehmen kann, wo ihre Grenzen liegen und wie die Ergebnisse geprüft werden müssen.

**A – Ability (Fähigkeit in der Praxis): Score 3**  
Die Mitarbeitenden sind grundsätzlich in der Lage, mit einem KI-Assistenten zu arbeiten, benötigen dafür aber Schulungen, praktische Übungen und klare Anwendungsfälle.

**R – Reinforcement (Verankerung): Score 2**  
Maßnahmen zur nachhaltigen Verankerung fehlen bislang. Regelmäßiges Feedback, Erfolgserlebnisse und die sichtbare Entlastung bei langweiligen Aufgaben könnten die Akzeptanz langfristig stärken.

## 3. Barrier Points und Gegenmaßnahmen

**Regel:** Barrier Point = erste Stufe in der Reihenfolge A→D→K→A→R mit Score ≤ 3. Solange sie offen ist, tragen die nachfolgenden Stufen nicht.
...
**Verantwortlich:** Geschäftsführung und Personalabteilung · **Wann:** Innerhalb der nächsten Woche
